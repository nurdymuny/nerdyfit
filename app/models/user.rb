class User < ActiveRecord::Base
  ...
  class << self
    ...
    def get_fit_data(user_token)
      ...
      url = "https://www.googleapis.com/fitness/v1/users/me/dataSources/derived:com.google.step_count.delta:com.google.android.gms:merge_step_deltas/datasets/#{time_from}-#{time_to}"
